...
output_csv_path = r"C:\Users\alire\Desktop\Capstone Project\6.VisualizationAfterClustering\features_with_KMeansClusters_&_t-SNE_1.csv"
...
plt.suptitle("K-Means Clustering Analysis on t_SNE-Reduced Dataset", fontsize=16)
