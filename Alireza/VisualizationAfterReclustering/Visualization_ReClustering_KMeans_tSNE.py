...
df_kmeans = pd.read_csv(r"C:\Users\alire\Desktop\Capstone Project\10.Reclustering After Churn Labelling\KMeans_ReClustered_tSNE_with_churn.csv")
...
output_csv_path = r"C:\Users\alire\Desktop\Capstone Project\11.Visualization After ReClustering\features_with_KMeans_ReClusters_tSNE.csv"
...
plt.suptitle("K-Means Clustering Analysis on tSNE-Reduced Dataset", fontsize=16)
