...
df_original = pd.read_csv(r"C:\Users\alire\Desktop\Capstone Project\9.Model Training & Evaluating\RandomForest_trained_model.csv")

# Step 2: Load the KMeans-applied dataset (with PC1, PC2, and Cluster)
df_kmeans = pd.read_csv(r"C:\Users\alire\Desktop\Capstone Project\10.Reclustering After Churn Labelling\KMedoids_ReClustered_PCA_with_churn.csv")
...
output_csv_path = r"C:\Users\alire\Desktop\Capstone Project\11.Visualization After ReClustering\features_with_KMedoids_ReClusters_PCA.csv"
...
plt.suptitle("K-Medoids Clustering Analysis on PCA-Reduced Dataset", fontsize=16)
