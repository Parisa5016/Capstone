...
df_kmeans = pd.read_csv(r"C:\Users\alire\Desktop\Capstone Project\10.Reclustering After Churn Labelling\KMedoids_ReClustered_Autoencoder_with_churn.csv")
...
output_csv_path = r"C:\Users\alire\Desktop\Capstone Project\11.Visualization After ReClustering\features_with_KMedoids_ReClusters_Autoencoder.csv"
...
plt.suptitle("K-Medoids Clustering Analysis on Autoencoder-Reduced Dataset", fontsize=16)
